...
public class ComplexTest {
    ...
    void testmultiply(){
        ...
        for (int testNumber = 0; testNumber < 5; testNumber++) {
            ...
            assertEquals(new Complex(complex[0].real*complex[1].real - (complex[0].imaginary * complex[1].imaginary), complex[0].real*complex[1].imaginary + complex[1].real*complex[0].imaginary), complex[0].multiply(complex[1]));
    ...
    void testPow(){
        ...
        Random random = new Random(0);
        Complex complex, complexExpected;
        int p = random.nextInt(100);

        for (int testNumber = 0; testNumber < 5; testNumber++) {

            complex = new Complex(random.nextDouble()+1, random.nextDouble()+1);
            complexExpected = new Complex(complex.real, complex.imaginary);

            for(int nbMultiply =0; nbMultiply < p; nbMultiply++){

                complexExpected = complexExpected.multiply(complex);

            }

            assertEquals(complexExpected, complex.pow(p));
        }
